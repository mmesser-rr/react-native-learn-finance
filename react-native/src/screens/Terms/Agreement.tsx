...
import {AgreementProps} from 'src/types/routerTypes';
...
const Agreement: React.FC<AgreementProps> = ({navigation, route}) => {
  const onClose = () => {
  ...
  return (
    <AppLayout containerStyle={styles.container} viewStyle={styles.viewStyle}>
      <View style={styles.header}>
        ...
        <Text type="Title/Large">Mobile Deposit Agreement</Text>
      </View>
      <View>
        <View>
