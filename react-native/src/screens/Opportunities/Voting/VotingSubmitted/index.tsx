...
import { IVotingSubmittedScreenProps } from 'src/types/opportunitiesRouterTypes';
...
const VotingSubmitted: React.FC<IVotingSubmittedScreenProps> = ({navigation, route}) => {
    ...
    return (
        <View style={styles.container} >
            ...
            <ImageBackground source={cloudImage} style={styles.image}>  
                ...
                <Text type="body/Medium" variant="white">Thank you for your voting submission!</Text>
            </ImageBackground>
        </View>
    )
}

export default VotingSubmitted;